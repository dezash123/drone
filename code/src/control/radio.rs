...
impl Radio {
    ...
    pub fn get_command(&self) -> RadioCommand {
        ...
        RadioCommand {
            z_throttle: channels[2] * channels[5],
            y_throttle: (channels[1] * 2.0 - 1.0) * channels[5],
            x_throttle: (channels[0] * 2.0 - 1.0) * channels[5],
            twist_throttle: (channels[3] * 2.0 - 1.0) * channels[5],
